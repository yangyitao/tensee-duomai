...
function valid_phone(phone) {
    ...
    /// 验证联系号码
    /// </summary> 
    var patten = /^1\d{10}$|^(0\d{2,3}-?|\(0\d{2,3}\))?[1-9]\d{4,7}(-\d{1,8})?$/;
    //var regtel = /^\d{3,4}-?\d{7,9}$/;
    return !patten.test(phone);
}
function valid_cardid(idcard) {
    /// <summary>
    /// 验证身份证号码
    /// </summary>
